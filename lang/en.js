export default {
  ...
  From: 'from',
  BirthDay: 'Birthday',
  TellPeopleYourStory: 'Tell other people about your with story',
  CharacterRemaining: 'Character remaining',
  SuccessChangeStoryMessage: 'Change story successfully!',
  Block: 'Block this user',
  Follow: 'Follow',
  AreFollowed: 'are followed',
  Peoples: 'Peoples',
  Following: 'Following',
  EmailOrUsername: 'Email or username',
  ThisPostNotHaveAnyLike: 'This post not have any like',
  ...
  Blocked: 'Blocked',
  SearchFriend: 'Search your friends',
  SeeAllFriends: 'See your all friends',
  Clear: 'Clear',
  Done: 'Done',
  Posts: 'Posts',
  All: 'All',
  PeoplesLikePost: 'Peoples like this post',
  CommentsInPost: 'Comments in this post',
  CommentSomething: 'Comment something ...',
  ShowMoreComments: 'Show more comment',
  More: 'More',
